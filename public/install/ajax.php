    ...
    try {
        ...
        echo json_encode([
          ...
          [
              ...
              'msg' => $admin_update_status && $env_update_status && $import_database ? 'Instalation Successful, if you still see install notice in your website, clear your browser cache '.'<a href="'.$installation_path.'">visit website</a>' : 'Installation Failed'
          ]
        ]);
