<div class="course-single-grid-item">
    ...
    <div class="content">
        ...
        <div class="instructor-wrap"><span>{{__('By')}}</span> <a href="{{route('frontend.course.instructor',[Str::slug(optional($course->instructor)->name),$course->instructor->id])}}">{{optional($course->instructor)->name}}</a></div>
